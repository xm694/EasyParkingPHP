...
?>
    ...
    <html>
        <head>
            <title>user get history</title>
            <!-- Bootstrap CSS -->
            <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/css/bootstrap.min.css">
        </head>
        <body>
            <h2 style="text-align: center">Thank you for parking with us!</h2>
            <button href="#" class="btn-default btn-block"> My history parking </button>
            ...
            <?php 
                ...
                try{
                    ...
                    $qRes = UserParking :: GetParkingHistory($u_id);
                    if ($qRes == false) {
                        ...
                        foreach($parkings as $parking) {
                            ...
                            echo "<td>". htmlentities($parking["CheckOutTime"]) ."</td>";
                            echo "<td>". htmlentities($parking["TotalCost"]) ."</td>";
                            echo "</tr>";
                        }
